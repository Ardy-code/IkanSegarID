    ...
    setTimeout(() => {
      ...
      if (trackingId === "FISH123") {
        setResult({
          ...
          certifications: [
            "Panen Berkelanjutan Tersertifikasi",
            "Mitra Air Bersih",
          ],
          image:
            "https://images.unsplash.com/photo-1518890569493-668df9a00266?w=500&auto=format&fit=crop&q=80",
        });
      } else {
        setError(
          "Tidak ditemukan informasi pelacakan untuk ID ini. Coba FISH123 untuk demo."
        );
        setResult(null);
      }
      setIsLoading(false);
      ...
      <div className="section-container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-[400px] md:h-[500px] rounded-xl overflow-hidden">
            <img
              src="https://media.istockphoto.com/id/1255754954/id/video/school-of-fish-sharks-berenang-dalam-lingkaran.jpg?s=640x640&k=20&c=ZcUGgzosypYflO0dMrhbRUtD2cY1Cv21Ui9eUFrkj4A="
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end">
              <div className="p-6 text-white">
                ...
                <p className="mb-4">
                  Jaringan peternak lokal kami yang berdedikasi memprioritaskan
                  keberlanjutan dan kualitas dalam setiap panen.
                </p>
                <Button
                  variant="outline"
